...
/* ------------------------------------------------
   1.  LOADER
   - GSAP gère le timing du compteur → fiable, pas de
     conflit rAF / performance.now().
   - Durée 0.7s linéaire + 0.5s slide = 1.2s total.
   - Visite déjà vue dans la session → skip immédiat.
------------------------------------------------ */
